...
export const concerns2: Concern[] = [
  ...
  },
  {
    ...
    category: "Hospitality & Leisure",
    tagline: "Tranquil lakeside eco-cottages, serene boat rides, open-air dining, and relaxing countryside weekend getaways.",
  ...
  // Agro & Fresh Produce
  {
    ...
    tagline: "Commercial organic crop cultivation, high-yield vegetable complexes, fruit orchards, floriculture & wholesale farmgate supply.",
    logo: "/images/brand/sampanechoagro.png",
