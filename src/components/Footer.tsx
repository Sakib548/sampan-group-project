...
const sitemap = [
  ...
  },
  {
    title: "Real Estate",
    links: [
      { label: "SDL", href: "/our-divisions/real-state-and-land-investment/sampan-development-ltd" },
      { label: "Metro Square", href: "/our-divisions/real-state-and-land-investment/sampan-metro-square" },
      { label: " Skyline", href: "/our-divisions/real-state-and-land-investment/sampan-skyline" },
      { label: "Nexus", href: "/our-divisions/real-state-and-land-investment/sampan-nexus" },
      // { label: "Residency Tower 1 & 2", href: "/real-estate/residency" },
      { label: "Taj", href: "/our-divisions/real-state-and-land-investment/sampan-taj" },
      { label: "Niketon", href: "/our-divisions/real-state-and-land-investment/sampan-niketon" },
      { label: "21st Century", href: "/our-divisions/real-state-and-land-investment/sampan-21st-century" },
      { label: "Trade Emporium", href: "/our-divisions/real-state-and-land-investment/sampan-trade-emporium" },
      { label: "Cafe Metro", href: "/our-divisions/real-state-and-land-investment/sampan-cafe-metro" },
    ],
  },
  {
    title: "Hospitality & Travel",
    links: [
      { label: "Highway Inn", href: "/our-divisions/hospitality-highway-travel/sampan-highway-inn" },
      { label: "Express Highway Inn", href: "/our-divisions/hospitality-highway-travel/express-highway-inn" },
      { label: "EHCL", href: "/our-divisions/hospitality-highway-travel/express-highway-inn-club-lounge" },
      { label: "White House", href: "/our-divisions/hospitality-highway-travel/sampan-white-house" },
      { label: "Eco & Agro Resort", href: "/our-divisions/hospitality-highway-travel/sampan-eco-agro" },
      { label: "Agro & Golf Resort", href: "/our-divisions/hospitality-highway-travel/sampan-agro-golf-resort" },
    ],
    secondary: {
      title: "Golf Zone",
      links: [

        { label: "Golf Academy", href: "/our-divisions/golf-zone/sampan-golf-academy" },
        { label: "Short Drive Range", href: "/our-divisions/golf-zone/sampan-short-drive-range" },
      ],
    },
  },
  {
    ...
    secondary: {
      title: "Agro & Retail",
      links: [
        { label: "Eco & Agro", href: "/our-divisions/agro-fresh-produce/sampan-eco-agro" },
        { label: "Sampan Mart", href: "/our-divisions/retail-super-shops/sampan-mart" },
        { label: "Mini Sampan", href: "/our-divisions/retail-super-shops/mini-sampan-super-shop" },
        { label: "Sweet Box", href: "/our-divisions/retail-super-shops/sampan-sweet-box" },
      ],
    },
  },
  {
    ...
    links: [
      { label: "Hollow Bricks & Tile", href: "/our-divisions/manufacturing-industrial/sampan-hollow-bricks-tiles" },
      { label: "Pet & Beverage", href: "/our-divisions/manufacturing-industrial/sampan-pet-beverage" },
      { label: "Industrial Park", href: "/our-divisions/manufacturing-industrial/sampan-industrial-park" },
      { label: "Sampan Auto", href: "/our-divisions/automotive-fuel-mobility/sampan-auto" },

      { label: "Filling Station", href: "/our-divisions/automotive-fuel-mobility/sampan-filling-station" },
      { label: "LPG ", href: "/our-divisions/automotive-fuel-mobility/sampan-lpg-filling-station" },
      { label: "Ev Charging Station ", href: "/our-divisions/automotive-fuel-mobility/sampan-ev-car-charging-station" },

      { label: "Towing", href: "/our-divisions/automotive-fuel-mobility/sampan-towing-service" },
    ],
  },
  {
    title: "Defense & Maritime",
    links: [
      { label: "Fire Arms Co.", href: "/our-divisions/defense-security/sampan-fire-arms-co" },
      { label: "Nagar Arms", href: "/our-divisions/defense-security/nagar-arms-ammunition" },
      { label: "Floating Pearl", href: "/our-divisions/maritime-alternative-assets/sampan-floating-pearl" },
    ],
  },
];
