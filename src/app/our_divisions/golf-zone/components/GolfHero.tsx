...
export default function GolfHero({
  ...
  return (
    <section className="relative overflow-hidden bg-[#091e15] text-white pt-32 pb-20 px-6 sm:px-12 lg:px-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div>
            ...
            <p className="mt-3 text-lg sm:text-xl font-medium text-emerald-200/90">
              {subtitle}
            </p>
          </div>
