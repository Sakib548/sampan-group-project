...
const farmImage = "/images/concerns/eco-agro.png";
const farmMark = "/images/concerns/3-sampan-eco-agro.png";
const fruits = "/images/our_divisions/eco_agro/fruits.jpg";
const veg = "/images/our_divisions/eco_agro/veg.jpg";
const seasonal = "/images/our_divisions/eco_agro/seasonal.jpg";
const crops = [
  {
    name: "Fruits",
    image: fruits,
    copy: "Seasonal fruit, grown slowly and picked with care.",
  },
  {
    name: "Vegetables",
    image: veg,
