        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-8">
            ...
            <h2 className="text-[clamp(2.2rem,4.5vw,4rem)] font-semibold leading-[0.95] tracking-[-0.03em] text-neutral-950">
              Ready to pause <br />
              <span className="text-emerald-700">your journey?</span>
            </h2>

            <p className="text-base sm:text-lg text-neutral-600 leading-relaxed max-w-xl font-normal">
              Whether you are planning an executive overnight stay, booking a family banquet, reserving an EV charging bay, or organizing a large tour coach stop, our concierge is ready 24/7.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              ...
              >
                ...
                <div>
                  <p className="font-mono text-[10px] font-bold uppercase tracking-wider text-neutral-500">Direct Hotline</p>
                  <p className="text-sm font-bold text-neutral-950 mt-0.5 group-hover:text-emerald-700 transition-colors">+880 1929-918408</p>
                  <p className="text-[10px] text-neutral-400 mt-1 font-mono">24/7 Instant Line</p>
                </div>
              </a>

              <a
                href="https://wa.me/8801929918408?text=Hello%20Sampan%20Highway%20Inn,%20I%20would%20like%20to%20enquire%20about%20a%20stopover%20reservation."
                target="_blank"
                rel="noreferrer"
                className="group p-5 rounded-none bg-white border border-neutral-200 hover:border-emerald-700 transition-all duration-300 flex items-start gap-4 shadow-sm"
              >
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-neutral-950 mt-0.5 group-hover:text-emerald-700 transition-colors">Chat Instantly</p>
              ...
              <div className="p-5 rounded-none bg-white border border-neutral-200 flex items-start gap-4 shadow-sm">
                <div className="p-3 rounded-none bg-emerald-50 text-emerald-800">
                  <FaMapMarkerAlt />
                </div>
                <div>
                  <p className="font-mono text-[10px] font-bold uppercase tracking-wider text-neutral-500">Corridor Location</p>
                  <p className="text-xs font-bold text-neutral-950 mt-0.5">KM 74, Dhaka-Khulna Highway</p>
                  <p className="text-[10px] text-neutral-400 mt-1 font-mono">Direct Slipway Frontage</p>
                </div>
              </div>
              ...
              {!isSubmitted ? (
                <>
                  <div className="flex items-center justify-between pb-6 border-b border-neutral-200 mb-6">
                    ...
                    <div className="w-10 h-10 rounded-none bg-emerald-50 border border-emerald-300 text-emerald-800 flex items-center justify-center">
                      <HiSparkles />
                    </div>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4 text-xs">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full bg-[#F5F5F2] border border-neutral-300 rounded-none p-3.5 text-neutral-950 focus:outline-none focus:border-emerald-700 cursor-pointer"
                        >
                          <option value="Room & Stay">VVIP Rooms &amp; Suites</option>
                          <option value="Day Pass Transit">Day Pass / Transit Rest</option>
                          <option value="Celebration Event">Celebration &amp; Party Banquet</option>
                          <option value="Corporate Outing">Corporate Offsite &amp; Meeting</option>
                          <option value="EV Supercharger">EV Fleet Charging Reservation</option>
                    ...
                    <div>
                      <label className="block font-mono text-[10px] font-bold uppercase tracking-wider text-neutral-700 mb-1.5">
                        Specific Requests or Group Size
                      </label>
                      <textarea
                        rows={3}
                        placeholder="e.g. Need 2 king rooms, 1 EV charging slot, and lunch for 6 guests..."
                    ...
                    <button
                      type="submit"
                      className="w-full py-4 rounded-none bg-neutral-950 hover:bg-emerald-700 text-white font-mono font-bold uppercase tracking-[0.2em] text-xs transition-all duration-300 cursor-pointer shadow-sm"
                    >
                ...
                <div className="text-center py-10 space-y-4">
                  <div className="w-16 h-16 rounded-none bg-emerald-50 text-emerald-800 text-3xl flex items-center justify-center mx-auto border border-emerald-300">
                    <FaCheckCircle />
                  </div>
                  <h3 className="text-2xl font-bold text-neutral-950">Enquiry Successfully Dispatched!</h3>
                  <p className="text-sm text-neutral-600 max-w-md mx-auto leading-relaxed">
                    Thank you <strong className="text-emerald-800">{formData.name}</strong>. Our front desk concierge has received your request for <strong>{formData.serviceType}</strong> and will call <span className="text-neutral-950 font-mono font-bold">{formData.phone}</span> shortly.
                  </p>

                  <div className="pt-6 flex flex-col sm:flex-row items-center justify-center gap-3">
                    <a
                      href={`https://wa.me/8801929918408?text=Hello%20Sampan%20Highway%20Inn,%20I%20just%20submitted%20an%20enquiry%20for%20${encodeURIComponent(formData.name)}%20(${encodeURIComponent(formData.serviceType)})`}
                      target="_blank"
                      rel="noreferrer"
                      className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-none bg-emerald-700 hover:bg-emerald-800 text-white px-6 py-3 font-mono text-xs font-bold uppercase tracking-wider"
                    >
                      <FaWhatsapp className="text-base" />
