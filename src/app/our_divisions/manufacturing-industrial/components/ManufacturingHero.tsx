...
export default function ManufacturingHero({
  ...
  return (
    <section className="relative overflow-hidden pt-28 sm:pt-32 pb-12 lg:pt-36 lg:pb-16 bg-[#090d16] text-white border-b border-white/10">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1440px] px-6 sm:px-10 lg:px-16">
        <div className="max-w-4xl space-y-5 sm:space-y-6">
          ...
          {/* Sleek Description */}
          <p
            className="text-xs sm:text-sm text-gray-300 leading-relaxed max-w-lg font-light tracking-wide border-l-2 pl-4"
