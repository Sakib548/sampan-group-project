...
export default function LandSharePage() {
      ...
      mm.add("(prefers-reduced-motion: no-preference)", () => {
        ...
        heroTl
          ...
          .fromTo(
            ...
            { autoAlpha: 0.05, scale: 1, duration: 1.5, ease: "power2.out" },
            "-=1.2"
          );
        ...
        // 4. Map Subtle Horizontal Movement
        gsap.fromTo(
          ".map-container",
          { xPercent: -2 },
          {
  ...
  return (
    <main
      ref={containerRef}
      className="bg-stone-50 text-zinc-900 overflow-x-hidden antialiased"
    >
      {/* 1. HERO SECTION */}
      <section className="hero-section relative h-screen w-full flex items-center bg-zinc-950 text-white overflow-hidden">
        ...
        <span className="hero-number absolute right-4 top-4 z-[2] text-[clamp(8rem,20vw,20rem)] font-bold leading-none text-white/5 select-none">
          01
        </span>

        <div className="hero-content relative z-10 mx-auto max-w-[1400px] px-6 md:px-12 w-full will-change-transform">
          ...
          <div className="hero-sub mt-10 max-w-2xl">
            <p className="text-lg leading-relaxed text-zinc-200/80">
              Own a fraction of prime real estate. We break down high-value
              land into manageable shares, making premium property investment
      ...
      <section className="bg-stone-50 py-24 lg:py-32 border-b border-zinc-200">
        <div className="mx-auto max-w-[1400px] px-6 md:px-12 grid grid-cols-12 gap-8">
          <div className="col-span-12 md:col-span-4">
            <p className="reveal-up text-xs font-semibold uppercase tracking-[0.3em] text-emerald-700 mb-4">
              How it Works
            </p>
            <img src="/images/about/mission.png" alt="" />
          </div>
          <div className="col-span-12 md:col-span-8">
            <h2 className="reveal-up text-[clamp(2rem,4vw,3.5rem)] font-semibold leading-[1.1] tracking-tight text-zinc-900">
              Own a piece of the land, without buying the whole plot.
            </h2>
            <p className="reveal-up mt-8 text-lg leading-loose text-zinc-600 max-w-3xl">
      ...
      <section className="bg-white py-24 lg:py-32 border-b border-zinc-200">
        <div className="mx-auto max-w-[1400px] px-6 md:px-12">
          <p className="reveal-up mb-4 text-xs font-semibold uppercase tracking-[0.3em] text-emerald-700">
            Current Openings (SMS)
          </p>
          <h2 className="reveal-up text-[clamp(2rem,4vw,3.5rem)] font-semibold leading-[1.1] tracking-tight mb-16 text-zinc-900">
            Available Opportunities
          </h2>

          <div className="grid grid-cols-12 gap-8">
            {/* Open Projects */}
            <div className="col-span-12 md:col-span-8 flex flex-col gap-0 border-t border-zinc-200">
              {openOpportunities.map((project) => (
                <div
                  key={project.num}
                  className="reveal-up group border-b border-zinc-200 py-8 hover:bg-stone-50 transition-all duration-300 cursor-pointer"
                >
                  <div className="grid grid-cols-12 gap-4 items-center">
                    <span className="col-span-2 text-xl font-semibold text-zinc-300 group-hover:text-emerald-600 transition-colors">
                      {project.num}
                    </span>
                    <div className="col-span-10 md:col-span-6">
                      <h3 className="text-xl md:text-2xl font-semibold tracking-tight text-zinc-900">
                        {project.name}
                      </h3>
                      <p className="flex items-center gap-2 mt-2 text-xs uppercase tracking-widest text-zinc-500">
                    ...
                    <div className="col-span-12 md:col-span-4 flex flex-col md:items-end">
                      ...
                      <span className="mt-1 text-xs font-medium text-emerald-700 bg-emerald-50 px-2 py-1 rounded-sm">
                        {project.shares}
                      </span>
                    </div>
                  </div>
            ...
            {/* Brochure Download */}
            <div className="col-span-12 md:col-span-4">
              <div className="reveal-up bg-zinc-900 text-white p-10 h-full flex flex-col justify-between border border-zinc-800">
                <div>
                  <h3 className="text-2xl font-semibold leading-tight mb-4">
                    Investment Prospectus
                  </h3>
                  <p className="text-zinc-400 text-sm leading-relaxed mb-8">
                    Download detailed financial models, land surveys, and exit
                    strategies for all current Land Share projects.
                  </p>
                </div>
                <button className="group flex items-center justify-between w-full border border-zinc-700 px-5 py-4 hover:bg-emerald-500 hover:border-emerald-500 hover:text-zinc-900 transition-all">
      ...
      <section className="bg-stone-50 py-24 lg:py-32 border-b border-zinc-200">
        <div className="mx-auto max-w-[1400px] px-6 md:px-12">
          {/* Stats */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-20 pb-16 border-b border-zinc-200">
            {trustSignals.map((stat, i) => (
              <div key={i} className="reveal-up flex flex-col">
                <span className="text-4xl md:text-6xl font-semibold text-zinc-900 tracking-tight">
                  {stat.value}
                </span>
          ...
          <div className="grid grid-cols-12 gap-8">
            <div className="col-span-12 md:col-span-2">
              <p className="reveal-up text-xs font-semibold uppercase tracking-[0.3em] text-emerald-700">
                Investor Voice
              </p>
            </div>
            <div className="col-span-12 md:col-span-10">
              <blockquote className="reveal-up text-[clamp(1.5rem,3vw,2.5rem)] font-medium leading-[1.4] tracking-tight text-zinc-800">
                &ldquo;Investing in Land Share was seamless. I always thought
                real estate required massive capital, but Sampan Development
                made it accessible. The legal transparency gave me absolute
                confidence.&rdquo;
              </blockquote>
              <div className="reveal-up mt-10 flex items-center gap-4">
                <div className="h-12 w-12 rounded-full bg-zinc-300 border border-zinc-400" />
                <div>
                  <p className="font-bold text-zinc-900">Rahim Uddin</p>
                  <p className="text-sm text-zinc-500">Investor since 2021</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-zinc-950 py-24 lg:py-32 text-white border-y border-zinc-800">
        <div className="mx-auto max-w-[1400px] px-6 md:px-12 grid grid-cols-12 gap-8">
          <div className="col-span-12 md:col-span-5">
            ...
            <p className="reveal-up mt-6 text-zinc-400 max-w-md leading-relaxed">
          ...
          <div className="col-span-12 md:col-span-7 md:pl-12">
            <ul className="divide-y divide-zinc-800 border-y border-zinc-800">
              {legalCredentials.map((cred, i) => (
                <li
                  key={i}
                  className="reveal-up flex items-center justify-between py-6"
                >
                  <span className="text-lg md:text-xl font-medium text-zinc-100">
                    {cred}
                  </span>
        ...
        <div className="mx-auto max-w-[1400px] px-6 md:px-12">
          ...
          <div className="grid grid-cols-12 gap-8">
            ...
            <div className="reveal-up col-span-12 md:col-span-6 overflow-hidden">
              <div className="map-container relative h-[450px] w-full border border-zinc-200 bg-stone-50 overflow-hidden will-change-transform">
                ...
                <div className="absolute left-[30%] top-[40%] flex flex-col items-center">
                  ...
                  <span className="mt-4 text-xs uppercase tracking-widest text-zinc-700 font-bold">
                    Ashulia SMS
                  </span>
                </div>
                ...
                <span className="absolute bottom-4 left-4 text-[10px] font-mono text-zinc-400 uppercase">
                  23.8728° N, 90.3984° E
                </span>
              </div>
            </div>
            ...
            {/* Video Tour */}
            <div className="reveal-up col-span-12 md:col-span-6 flex flex-col justify-center">
              <div className="aa-parallax-image-wrapper group relative aspect-video w-full overflow-hidden bg-zinc-900 cursor-pointer mb-6">
                <Image
                  src="/images.jpg"
                  alt="Video Tour"
                  fill
      ...
      <section className="bg-stone-50 py-24 lg:py-32 border-b border-zinc-200">
        <div className="mx-auto max-w-[1400px] px-6 md:px-12 grid grid-cols-12 gap-8 items-center">
          {/* Calculator */}
          <div className="reveal-up col-span-12 md:col-span-7 bg-zinc-900 text-white p-8 md:p-12 border border-zinc-800">
            ...
            <div className="space-y-8">
              <div>
                <div className="flex justify-between mb-3">
                  ...
                  <span className="font-bold text-emerald-400 text-lg">2 Shares</span>
                </div>
                <input
                  type="range"
                  min="1"
          ...
          <div className="reveal-up col-span-12 md:col-span-5 flex flex-col justify-center pl-0 md:pl-8">
            <h3 className="text-3xl md:text-4xl font-semibold leading-tight mb-6 tracking-tight text-zinc-900">
            ...
            <Link
              href="#contact"
              className="group inline-flex items-center gap-4 text-lg font-bold border-b-2 border-emerald-600 pb-2 w-fit text-zinc-900 hover:text-emerald-700 transition-colors"
            >
              Book Site Visit{" "}
      ...
      <section className="nrb-section relative bg-zinc-950 py-24 lg:py-32 text-white overflow-hidden border-y border-zinc-800">
        <div className="absolute inset-0 overflow-hidden">
          <Image
            src="/nrb-bg.jpg"
            ...
            sizes="100vw"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-zinc-950 to-zinc-950/80 z-[1]"></div>
        </div>

        <div className="relative z-10 mx-auto max-w-[1400px] px-6 md:px-12 grid grid-cols-12 gap-8">
          <div className="reveal-up col-span-12 md:col-span-6">
            ...
            <p className="mt-6 text-zinc-300 max-w-lg leading-relaxed">
          ...
          <div className="reveal-up col-span-12 md:col-span-6 flex flex-col justify-center gap-4">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group flex items-center justify-between bg-emerald-500 text-zinc-900 px-8 py-5 hover:bg-white transition-colors border border-emerald-500"
            >
              <span className="text-sm font-bold uppercase tracking-widest flex items-center gap-3">
                <FiMessageCircle className="text-xl" /> Direct WhatsApp Advisor
              </span>
              <FiArrowRight className="transition-transform group-hover:translate-x-2" />
            </a>
            <Link
              href="/crm-enquiry"
              className="group flex items-center justify-between border border-zinc-700 px-8 py-5 hover:border-emerald-500 hover:text-emerald-400 transition-colors"
            >
      ...
      <section className="bg-white py-24 lg:py-32 border-b border-zinc-200">
        <div className="mx-auto max-w-[800px] px-6">
          <p className="reveal-up mb-4 text-xs font-semibold uppercase tracking-[0.3em] text-emerald-700 text-center">
            FAQ
          </p>
          <h2 className="reveal-up text-[clamp(2rem,4vw,3.5rem)] font-semibold leading-tight tracking-tight mb-16 text-center text-zinc-900">
          ...
          <div className="border-t border-zinc-200">
            {faqItems.map((item, i) => (
              <div key={i} className="reveal-up border-b border-zinc-200">
                <button
                  className="w-full flex justify-between items-center py-6 text-left hover:text-emerald-700 transition-colors"
                  onClick={() => setActiveFaq(activeFaq === i ? null : i)}
                >
                  <span className="text-lg font-semibold pr-4">{item.q}</span>
                  <FiChevronDown
                    className={`h-5 w-5 text-emerald-600 transition-transform duration-300 flex-shrink-0 ${
                ...
                >
                  <div className="overflow-hidden">
                    <p className="text-zinc-600 leading-loose pr-8">
                      {item.a}
                    </p>
                  </div>
                </div>
      ...
      {/* 10. FINAL CTA */}
      <section className="cta-section relative min-h-[60vh] bg-zinc-950 text-white flex flex-col justify-center overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          <Image
            src="/cta-bg.jpg"
            alt="Ready to Invest"
            ...
            sizes="100vw"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-zinc-950 to-zinc-950/80 z-[1]"></div>
        </div>

        <div className="relative z-10 mx-auto max-w-[1400px] px-6 md:px-12 w-full">
          <h2 className="text-[clamp(2.5rem,6vw,5.5rem)] font-semibold leading-[1.05] tracking-tighter">
            READY TO <br />
          ...
          <div className="reveal-up mt-16">
            <Link
              href="/contact"
              className="group flex items-center gap-6 text-xl font-semibold border-b border-zinc-700 pb-4 transition-colors hover:border-emerald-500 hover:text-emerald-400 md:text-2xl w-fit"
            >
              START YOUR APPLICATION
              <span className="flex h-12 w-12 items-center justify-center rounded-full border border-zinc-600 transition-all group-hover:border-emerald-500 group-hover:bg-emerald-500 group-hover:text-zinc-900">
                <FiArrowRight />
              </span>
            </Link>
          </div>
