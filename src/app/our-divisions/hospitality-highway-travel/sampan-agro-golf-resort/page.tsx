  ...
  return (
    <main className="min-h-screen bg-[#f8faf6] text-[#183b2b]">
      ...
      <ResortHero
        ...
        bannerImage="/images/our-divisions/sampan_agro_golf_resort/sampan-agro-golf-resort.png"
        backgroundImage="/images/our-divisions/sampan_agro_golf_resort/sampan-agro-golf-resort.png"
      />
