...
const fruits = "/images/our-divisions/eco_agro/fruits.jpg";
const veg = "/images/our-divisions/eco_agro/veg.jpg";
const seasonal = "/images/our-divisions/eco_agro/seasonal.jpg";
const crops = [
  {
    name: "Fruits",
    image: fruits,
