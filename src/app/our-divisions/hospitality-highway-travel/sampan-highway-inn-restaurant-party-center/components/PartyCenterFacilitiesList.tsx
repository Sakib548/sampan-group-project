      ...
      <div className="mx-auto max-w-[1440px] px-6 sm:px-10 lg:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {facilitiesData.map((item) => (
            <article
              key={item.id}
              className="group flex flex-col rounded-none overflow-hidden bg-white border border-neutral-200/80 shadow-sm hover:shadow-xl hover:border-amber-500/40 transition-all duration-500 hover:-translate-y-1.5"
            >
              {/* Card Image */}
              <div className="relative aspect-square overflow-hidden bg-neutral-100">
                ...
                />
                <div className="absolute top-3 left-3 bg-black/70 backdrop-blur-md px-3 py-1 rounded-none text-[10px] font-bold uppercase tracking-widest text-amber-400">
                  {item.badge}
                </div>
