        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            ...
            <h2 className="text-[clamp(2.2rem,4.5vw,4rem)] font-semibold leading-[0.95] tracking-[-0.03em] text-neutral-950">
              ...
              <span className="text-amber-700">For every celebration &amp; traveler.</span>
            </h2>
          </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {facilitiesData.map((item) => (
            <article
              ...
              className="group relative flex flex-col rounded-none overflow-hidden bg-[#F5F5F2] border border-neutral-200 hover:border-amber-600 transition-all duration-500 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] hover:-translate-y-1 cursor-pointer"
            >
              {/* Top Amber Line Hover */}
              <div className="absolute top-0 left-0 h-[3px] w-0 bg-amber-600 transition-all duration-700 group-hover:w-full z-10" />
              ...
              <div className="relative aspect-[16/10] overflow-hidden bg-neutral-200">
                ...
                {/* Square Badge */}
                <div className="absolute top-3.5 left-3.5 bg-white/90 backdrop-blur-md px-3 py-1 rounded-none border border-neutral-200 font-mono text-[9px] font-bold uppercase tracking-widest text-amber-800">
                  {item.badge}
                </div>
              </div>
              ...
              <div className="flex flex-1 flex-col p-6 bg-white">
                ...
                <h3 className="text-lg font-bold text-neutral-950 group-hover:text-amber-700 transition-colors leading-snug">
                  {item.title}
                </h3>
