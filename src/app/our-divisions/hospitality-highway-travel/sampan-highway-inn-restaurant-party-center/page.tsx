...
export const metadata: Metadata = {
  ...
  description:
    "Sampan Highway Inn Restaurant & Party Center at KM 103 on the Dhaka–Khulna Highway offers central AC banquet halls for 500+ guests, wedding reception packages, and fine highway dining.",
  keywords: [
    "Sampan Highway Inn Restaurant & Party Center",
    "Highway Party Center Bangladesh",
    "Dhaka Khulna Highway Wedding Venue",
    "Highway Party Center",
    "Highway Banquet Hall",
  ...
  openGraph: {
    title: "Sampan Highway Inn Restaurant & Party Center | Grand Event Hall & Fine Highway Dining",
    description:
      "Central air-conditioned banquet halls accommodating up to 500+ guests, gourmet feasts, and authentic culinary dining on the Dhaka–Khulna Highway corridor.",
    images: [
      {
