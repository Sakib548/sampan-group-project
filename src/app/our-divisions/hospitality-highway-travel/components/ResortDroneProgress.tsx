  ...
  return (
    <section className="py-20 px-6 sm:px-12 lg:px-20 bg-[#071d13] text-white">
      <div className="max-w-6xl mx-auto text-center">
        <span className="text-xs font-bold uppercase tracking-widest text-amber-300 bg-emerald-950 px-3.5 py-1 rounded-none border border-emerald-800">
        ...
        <div className="mt-12 relative aspect-video max-w-4xl mx-auto rounded-none overflow-hidden border-2 border-emerald-700/40 shadow-2xl bg-emerald-950 flex items-center justify-center group">
          <div className="text-center p-8 space-y-4">
            <div className="w-20 h-20 rounded-none bg-amber-400 text-emerald-950 flex items-center justify-center font-bold text-3xl mx-auto shadow-xl group-hover:scale-110 transition-transform cursor-pointer">
              ▶
            </div>
