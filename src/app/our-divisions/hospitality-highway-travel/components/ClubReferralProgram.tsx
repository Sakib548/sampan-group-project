  ...
  return (
    <section className="py-20 px-6 sm:px-12 lg:px-20 bg-white text-[#183b2b]">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-[#071d13] to-emerald-950 text-white rounded-none p-8 sm:p-12 shadow-2xl border border-emerald-700/40">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-sm text-emerald-100/80 leading-relaxed">
                Receive <strong className="text-amber-300">25,000 BDT</strong> in club resort credits for every successful executive member you introduce to SAGCL.
              </p>
                ...
                <div className="flex items-center gap-3">
                  {[1, 2, 3, 5, 10].map((num) => (
                    <button
                      ...
                      className={`px-4 py-2.5 rounded-none text-xs font-bold border transition-all ${
                        referralCount === num
            ...
            {/* Right Display */}
            <div className="lg:col-span-5 bg-emerald-900/40 border border-emerald-700/40 rounded-none p-6 text-center space-y-4">
              ...
              <a
                href="#club-signup"
                className="block w-full py-3.5 rounded-none bg-amber-400 hover:bg-amber-300 text-emerald-950 font-bold text-xs uppercase tracking-wider shadow-lg transition-all"
              >
