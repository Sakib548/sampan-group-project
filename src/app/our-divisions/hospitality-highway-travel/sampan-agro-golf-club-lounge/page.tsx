  ...
  return (
    <main className="min-h-screen bg-[#f8faf6] text-[#183b2b]">
      ...
      <ResortHero
        ...
        bannerImage="/images/our-divisions/sampan-agro-golf-club-lounge/hero_banner.jpg"
        backgroundImage="/images/our-divisions/sampan-agro-golf-club-lounge/hero_banner.jpg"
      />
