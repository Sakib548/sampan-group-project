...
const pressMentions = [
  {
    ...
    quote:
      "Sampan Highway Inn sets a benchmark for modern expressway transit. With triple-glazed luxury suites and high-capacity EV charging, it turns a grueling road trip into an effortless retreat.",
