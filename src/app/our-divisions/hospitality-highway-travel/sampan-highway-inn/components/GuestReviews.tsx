...
const reviewsData = [
  {
    ...
    content:
      "We stopped with our 2 kids and elderly parents on our way to Barishal. The cleanliness of the washrooms was 5-star hotel standard. Food was fresh and served in less than 15 minutes. The quiet rest room allowed my father to take an hour's nap peacefully.",
  ...
  },
  {
    ...
    date: "1 month ago",
    verified: true,
    title: "VVIP Suite was luxurious and quiet",
    content:
