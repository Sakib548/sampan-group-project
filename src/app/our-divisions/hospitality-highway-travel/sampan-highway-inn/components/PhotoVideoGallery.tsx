...
const galleryItems = [
  {
    ...
    category: "exterior",
    src: "/images/our-divisions/sampan-highway-inn/hero.jpeg",
  ...
  // },
  {
    ...
    category: "events",
    src: "/images/our-divisions/sampan-highway-inn/lounge.jpg",
    aspect: "col-span-1",
    caption: "Premium relaxation zone with complimentary refreshments and high-speed Wi-Fi.",
  },
  {
    id: 6,
    ...
    aspect: "col-span-1",
    caption: "Quench your thirst with our fresh, handcrafted juices made from locally sourced fruits.",
  },
  {
    id: 7,
    title: "Sampan Achar",
    ...
    aspect: "col-span-1",
    caption: "A taste of tradition packed in a jar.",
  },
  {
    id: 8,
    title: "VIP Lounge",
    ...
    aspect: "col-span-2 row-span-2",
    caption: "Lavish seating with premium amenities for exclusive relaxation.",
  },
  {
    id: 9,
    title: "Sweet Shop",
    ...
    aspect: "col-span-2 row-span-2",
    caption: "Discover our freshly baked sweets and savouries, prepared daily with the finest ingredients.",
  },
  {
    id: 10,
    ...
    aspect: "col-span-2 row-span-2",
    caption: "Serving up delicious and quick bites to keep you moving on your journey.",
  },

  {
    ...
    aspect: "col-span-2 row-span-2",
    caption: "A serene space for prayer and reflection, available for all guests.",
  },
