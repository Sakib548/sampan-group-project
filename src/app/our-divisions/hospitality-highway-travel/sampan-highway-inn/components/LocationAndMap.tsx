          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-8">
            ...
            <div className="pt-4 flex flex-wrap items-center gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-none bg-emerald-700 hover:bg-emerald-800 px-6 py-3.5 text-xs font-bold uppercase tracking-[0.16em] text-white shadow-lg shadow-emerald-700/20 transition-all duration-300"
              >
