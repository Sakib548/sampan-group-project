...
const ugcPosts = [
  ...
  },
  {
    ...
    likes: 472,
    comments: 31,
    caption: "A 2-hour power nap in a quiet room before the next 100km drive. Saved my energy completely. 🛌💯 #DriverSafety #SampanHighwayInn",
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-xs font-bold uppercase tracking-[0.28em] text-emerald-800">
                Traveler Community (#StopAtSampan)
              </p>
            </div>
