...
const miniShopProducts = [
  {
    ...
    image: "/images/our-divisions/mini-sampan-super-shop/bakery_milk_pack.png",
    tag: "Daily Essential",
  ...
  // },
  {
    ...
    image: "/images/our-divisions/mini-sampan-super-shop/brown_eggs.png",
  ...
  },
  {
    ...
    image: "/images/our-divisions/mini-sampan-super-shop/sampan_water_bottle.png",
    tag: "Best Value",
  ...
  },
  {
    ...
    image: "/images/our-divisions/mini-sampan-super-shop/noodles.png",
...
const photos = [
  { id: "photo-1", title: "Neighborhood Outlet", category: "Store Outlet", image: "/images/our-divisions/mini-sampan-super-shop/mart.jpg", caption: "Mini Sampan Super Shop Neighborhood Outlet" },
  ...
  return (
    <main className="min-h-screen bg-[#F5F5F2] text-neutral-950">
      ...
      <RetailHero
        ...
        bannerImage="/images/our-divisions/mini-sampan-super-shop/mart.jpg"
        facts={[
