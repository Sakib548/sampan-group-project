...
const sampanMartProducts = [
  ...
  // },
  {
    ...
    image: "/images/our-divisions/sampan-mart/olive_oil.jpg",
    tag: "Imported",
  ...
  },
  {
    ...
    priceBDT: "1,250 BDT",
    packSize: "5 kg Bag",
    image: "/images/our-divisions/sampan-mart/basmati.png",
    tag: "Super Saver",
  ...
  },
  {
    ...
    image: "/images/our-divisions/sampan-mart/dairy.png",
...
const photos = [
  { id: "photo-1", title: "Superstore Interior", category: "Store Outlet", image: "/images/our-divisions/sampan-mart/sampan-mart-inter.jpg", caption: "Sampan Mart Flagship Superstore Interior" },
  { id: "photo-2", title: "Organic Produce Aisle", category: "Fresh Produce", image: "/images/our-divisions/sampan-mart/sampan-mart-inter2.jpg", caption: "Fresh Farm Organic Produce & Gourmet Aisle" },
  ...
  return (
    <main className="min-h-screen bg-[#F5F5F2] text-neutral-950">
      ...
      <RetailHero
        ...
        bannerImage="/images/our-divisions/sampan-mart/sampan-mart.png"
        facts={[
