...
export const metadata: Metadata = {
  ...
  description:
    "Sampan Mart is a 24/7 convenience super shop located at the Sampan Highway Inn Complex on the Dhaka–Khulna Highway (KM 74, Gopalganj), offering cold drinks, snacks, travel toiletries, and daily provisions.",
  keywords: [
    "Sampan Mart",
    "24/7 Highway Super Shop",
    "Gopalganj Super Shop",
    "Sampan Highway Inn",
  ...
  openGraph: {
    ...
    description:
      "24/7 highway retail convenience super shop at the Sampan Highway Inn Complex on the Dhaka–Khulna Highway (KM 74, Gopalganj).",
    images: [
      {
