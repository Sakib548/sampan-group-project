  ...
  return (
    <main className="min-h-screen bg-[#f8faf6] text-[#183b2b]">
      ...
      <GolfHero
        ...
        bannerImage="/images/our-divisions/sampan-short-drive-range/hero_banner.jpg"
        backgroundImage="/images/our-divisions/sampan-short-drive-range/hero_banner.jpg"
      />
