...
const taglines: Record<string, string> = {
  ...
  "golf-zone": "Bangladesh’s new full golf destination is in the making.",
                ...
                {division.items.map((item) => {
                  const concernId =
                    typeof item === "object" && item !== null
                      ? (item as { concernId?: number | string; id?: number | string }).concernId ??
                        (item as { concernId?: number | string; id?: number | string }).id
                      : item;
