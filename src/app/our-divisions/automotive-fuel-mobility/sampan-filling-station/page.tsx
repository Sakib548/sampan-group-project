...
export const metadata: Metadata = {
  ...
  description:
    "Sampan Filling Station is a 24/7 digital-calibrated highway refueling station located at the Sampan Highway Inn Complex on the Dhaka–Khulna Highway (KM 74, Gopalganj), supplying Octane 95, Diesel, heavy vehicle bays, and official Mobil lubricants.",
  keywords: [
    "Sampan Filling Station",
    "24/7 Fuel Station Bangladesh",
    "Dhaka Khulna Highway Filling Station",
    "Gopalganj petrol pump",
  ...
  openGraph: {
    ...
    description:
      "24/7 digital-calibrated highway refueling station at the Sampan Highway Inn Complex on the Dhaka–Khulna Highway (KM 74, Gopalganj).",
    images: [
      {
