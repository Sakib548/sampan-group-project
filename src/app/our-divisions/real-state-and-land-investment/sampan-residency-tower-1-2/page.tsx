...
export const metadata: Metadata = {
  ...
  description:
    "Twin-tower luxury residential complex integrated with Express Highway Inn hospitality perks, executive suites, and land share ownership options.",
};
...
const units = [
  {
    ...
    highlights: ["Integrated Highway Inn Concierge Access", "Double-Glazed Acoustic Glass", "Covered Basement Parking"],
  },
  {
    id: "res-b",
...
const floorPlans = [
  {
    ...
    image: "/images/our-divisions/sampan-tower/architectural_floor_plans.jpg.jpeg",
    description: "4-unit per floor symmetrical layout with central high-speed lifts and acoustic insulation.",
    features: ["Dual High-Speed Passenger Lifts", "Acoustic Double Glass", "Fire Escape Stairs"],
  },
];
  ...
  return (
    <main className="bg-[#f3f6f2] text-[#183b2b] antialiased selection:bg-[#ca8a04] selection:text-neutral-950">
      ...
      <RealEstateHero
        ...
        image="/images/our-divisions/sampan-tower/sampan-tower.png"
        facts={facts}
        theme="dark-slate"
      />
      ...
      <UnitTypesAndSizes
        ...
        subtitle="Explore 3 & 4 bedroom executive suites with double-glazed acoustic glass."
        units={units}
