...
const maritimeConcerns = [
  {
    ...
    category: "Luxury Floating Resort & Destination Vessel",
    status: "Coming Soon - Under Fabrication",
    location: "Coastal & Riverine Waterways, Bangladesh",
    description: "Bangladesh's upcoming multi-tier luxury floating resort and destination vessel. Engineered with riverfront staterooms, an open-air sky garden, panoramic dining hall, and Sampan-branded cocktail lounge.",
    link: "/our-divisions/maritime-alternative-assets/sampan-floating-pearl",
    highlights: [
      "Multi-Tier Luxury Floating Architecture",
      "Rooftop Sky Garden & Signature Cafe",
      "Panoramic Ocean & River View Balcony Suites",
      "Fine Dining Hall & Onboard Wellness Center",
    ],
  },
];
