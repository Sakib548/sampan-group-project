...
const leaders = [
  ...
  },
  {
    name: "Shohidul Islam",
    role: "Director",
    image: "/images/leadership/Shohidul_Islam.png",
  },
];
...
const values = [
  {
    title: "Integrity",
    desc: "We uphold the highest ethical standards in every business endeavor, ensuring transparency and trust.",
  },
  {
    title: "Innovation",
    desc: "Continuously seeking modern solutions to complex industry challenges through technology and creativity.",
  },
  {
    title: "Excellence",
    desc: "Delivering premium quality across all our properties, services, and stakeholder interactions.",
  },
  {
    title: "Responsibility",
    desc: "Committed to sustainable growth, environmental stewardship, and community development.",
  },
];

const stats = [
  { value: 75, suffix: "+", label: "Countries" },
  { value: 26, suffix: "+", label: "Businesses" },
  { value: 50, suffix: "+", label: "Projects" },
  { value: 20, suffix: "+", label: "Years of Growth" },
];
...
export default function AboutUsPage() {
    ...
    () => {
      ...
      mm.add("(prefers-reduced-motion: no-preference)", () => {
        ...
        gsap.utils.toArray<HTMLElement>(".reveal-up").forEach((el) => {
          gsap.fromTo(el, { y: 40, autoAlpha: 0 }, { y: 0, autoAlpha: 1, duration: 1, ease: "power3.out", scrollTrigger: { trigger: el, start: "top 88%" } });
        });
          ...
          if (track) {
            ...
            gsap.to(track, {
              ...
              scrollTrigger: {
                ...
                onUpdate: (self) => {
                  if (progressBar) gsap.to(progressBar, { scaleX: self.progress, duration: 0.1, overwrite: true });
                },
              },
            });
          }
  ...
  return (
    <main ref={containerRef} className="bg-[#F5F5F2] text-neutral-950 overflow-x-hidden font-sans antialiased selection:bg-emerald-500 selection:text-white">
      ...
      {/* 01. CINEMATIC HERO */}
      <section className="hero-section relative min-h-[100svh] w-full flex items-end bg-[#050505] text-white overflow-hidden">
        <div className="hero-bg absolute inset-0 opacity-0 will-change-transform">
          <Image src="/images/about/About-Our-Company-2.png" alt="Sampan Group Architecture" fill className="object-cover" priority sizes="100vw" />
        </div>
        ...
        <div className="hero-content relative z-10 w-full pb-16 md:pb-24 pt-28">
          <div className="mx-auto max-w-[1600px] px-[5vw]">
            <p className="hero-eyebrow mb-6 font-mono text-[10px] md:text-[11px] font-semibold uppercase tracking-[0.4em] text-emerald-500 opacity-0 flex items-center gap-3">
              <span className="block w-8 h-px bg-emerald-500"></span>
              About Sampan Group
            </p>
            <h1 className="flex flex-col overflow-hidden text-[clamp(2.5rem,9vw,9rem)] font-semibold leading-[0.85] tracking-[-0.04em]">
            ...
            <p className="hero-desc mt-8 max-w-xl text-base md:text-lg leading-relaxed text-white/60 opacity-0">
        ...
        <div className="hero-bottom absolute bottom-8 left-0 right-0 z-10 hidden md:flex justify-between items-end px-[5vw] opacity-0">
          <div className="font-mono text-[10px] uppercase tracking-[0.3em] text-white/40">EST. 2005</div>
      ...
      <section className="bg-[#F5F5F2] py-20 md:py-24 lg:py-32 relative">
        <div className="mx-auto max-w-[1600px] px-[5vw]">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 mb-20">
            <div className="lg:col-span-5">
              ...
              <h2 className="reveal-up text-[clamp(2rem,5vw,5.5rem)] font-semibold leading-[0.95] tracking-[-0.03em]">
            ...
            <div className="lg:col-span-6 lg:col-start-7 flex flex-col justify-end gap-6">
              <p className="reveal-up text-lg md:text-xl text-neutral-800 leading-relaxed font-light">
          ...
          {/* Simplified Image Layout for responsiveness */}
          <div className="relative w-full mt-16 lg:mt-24">
            <div className="img-reveal-wrapper relative aspect-[16/10] md:aspect-[16/9] w-full overflow-hidden bg-neutral-200 border border-neutral-300">
              <Image
                src="/images/about/legacy.avif"
      ...
      <section className="bg-[#050505] py-20 lg:hidden text-white">
        <div className="mx-auto max-w-[1600px] px-[5vw]">
          <p className="font-mono text-[11px] font-semibold uppercase tracking-[0.4em] text-emerald-500 mb-4 flex items-center gap-3">
            <span className="block w-8 h-px bg-emerald-500"></span>
            Our Journey
          </p>
          <h2 className="text-[clamp(2rem,5vw,3rem)] font-semibold tracking-[-0.03em] mb-16 leading-none">
            A Journey of Progress.
          </h2>
            ...
            {milestones.map((m, i) => (
              <div key={i} className="flex gap-8 relative">
                ...
                <div className="pb-8 flex-1">
                  <span className="text-4xl font-bold text-emerald-500 block mb-3">{m.year}</span>
                  <h3 className="text-xl font-semibold mb-3 tracking-[-0.02em]">{m.title}</h3>
                  <p className="text-white/60 mb-6 text-sm leading-relaxed">{m.desc}</p>
      ...
      <section className="bg-[#F5F5F2] py-20 md:py-24 lg:py-32 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-[1600px] px-[5vw] grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          <div className="lg:col-span-7">
            <div className="md-video-wrapper relative aspect-video w-full overflow-hidden border border-neutral-300 bg-black cursor-pointer group opacity-0 shadow-xl">
              {!isPlaying ? (
                <>
                  <img
                  ...
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <button
                      ...
                      className="play-btn relative h-20 w-20 md:h-24 md:w-24 rounded-full border border-white/80 bg-black/30 backdrop-blur-md flex items-center justify-center transition-all duration-500 hover:bg-emerald-500 hover:border-emerald-500 pointer-events-auto"
                    >
                      <span className="absolute inset-0 rounded-full border border-white/20 animate-ping opacity-75"></span>
                      <FiPlay className="text-white text-2xl md:text-3xl group-hover:text-black transition-colors duration-300 ml-1" />
                    </button>
                  </div>

                  <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-8 flex items-end justify-between pointer-events-none">
                    <div>
                      <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-emerald-400 mb-2">
                        Leadership Message
                      </p>
                      <p className="text-base md:text-lg text-white/80 font-medium">
                        The vision behind Sampan Group.
                      </p>
                    </div>
                    <div className="hidden md:block font-mono text-[10px] text-white/40">
                      02:48 Min
                    </div>
                  </div>
                </>
          ...
          <div className="lg:col-span-5 lg:pl-8">
            ...
            <h2 className="reveal-up text-[clamp(2rem,5vw,4.5rem)] font-semibold leading-[0.95] tracking-[-0.03em] mb-8 text-neutral-950">
              A Message From Our <br />
              <span className="text-neutral-400">Managing Director.</span>
            </h2>

            <blockquote className="reveal-up border-l border-emerald-500 pl-6 mb-10 text-neutral-600 text-base md:text-lg leading-relaxed italic">
              &quot;Sampan Group is driven by a vision to create lasting value through innovation, responsible growth, and transformative opportunities that contribute to a stronger and more sustainable future.&quot;
            </blockquote>

            <div className="reveal-up flex items-center gap-4">
              <div className="h-px w-12 bg-neutral-300" />
              <div>
                <h3 className="text-lg md:text-xl font-bold tracking-tight text-neutral-950">
                  MD. EMAMUL HASAN
                </h3>
                <p className="font-mono text-[11px] uppercase tracking-[0.3em] mt-1 font-semibold text-emerald-700">
      ...
      {/* 05. GLOBAL FOOTPRINT */}
      <section className="bg-white py-20 md:py-24 lg:py-32 border-y border-neutral-200">
        <div className="mx-auto max-w-[1600px] px-[5vw] grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-7">
            ...
            <h2 className="reveal-up text-[clamp(2rem,5vw,5rem)] font-semibold tracking-[-0.03em] mb-12 leading-none">
              From Bangladesh to a<br />{" "}
              <span className="text-neutral-400">Global Scale</span>
            </h2>

            <div className="map-container relative w-full h-[300px] sm:h-[400px] lg:h-[500px] bg-[#F5F5F2] border border-neutral-200 overflow-hidden shadow-sm">
              <svg className="absolute inset-0 w-full h-full" viewBox="0 0 800 400">
                ...
                <path d="M150,200 Q300,50 500,180 T700,150" fill="none" stroke="#E5E7EB" strokeWidth="2" strokeDasharray="4 4" />
                <path className="map-path" d="M150,200 Q300,50 500,180 T700,150" fill="none" stroke="#10b981" strokeWidth="2" strokeLinecap="round" />
          ...
          <div className="lg:col-span-5 grid grid-cols-2 gap-8">
            {stats.map((s, i) => (
              <div key={i} className={`reveal-up pl-6 ${i % 2 === 0 ? "border-l-2 border-emerald-500" : "border-l-2 border-transparent"}`}>
                <span className="count-up text-5xl md:text-6xl lg:text-7xl font-bold block text-neutral-950 tracking-[-0.04em]" data-value={s.value} data-suffix={s.suffix}>0{s.suffix}</span>
      ...
      <section className="bg-[#F5F5F2] py-20 md:py-24 lg:py-32">
        <div className="mx-auto max-w-[1600px] px-[5vw]">
          <h2 className="reveal-up text-[clamp(2rem,5vw,5rem)] font-semibold leading-[0.95] tracking-[-0.03em] mb-16 lg:mb-20 text-center">
            Driven by Purpose. <br />{" "}
            <span className="text-neutral-400">Defined by Values.</span>
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-0 border-t border-b border-neutral-300/60 py-16">
            <div className="reveal-up md:border-r md:border-neutral-300/60 md:pr-12 pb-8 md:pb-0">
              <span className="text-5xl md:text-6xl font-bold text-neutral-950/[0.03] block mb-6 tracking-[-0.04em]">01</span>
              <h3 className="text-2xl font-semibold mb-6 tracking-[-0.02em]">Mission</h3>
              <p className="text-neutral-600 leading-relaxed text-lg">
                To build sustainable, industry-leading enterprises that drive economic growth and create lasting value for society.
              </p>
            </div>
            <div className="reveal-up md:border-r md:border-neutral-300/60 md:pr-12 md:pl-12 pb-8 md:pb-0">
              <span className="text-5xl md:text-6xl font-bold text-neutral-950/[0.03] block mb-6 tracking-[-0.04em]">02</span>
              <h3 className="text-2xl font-semibold mb-6 tracking-[-0.02em]">Vision</h3>
              <p className="text-neutral-600 leading-relaxed text-lg">
                To be the most trusted and diversified business group in Bangladesh, recognized globally for our innovation and integrity.
              </p>
            </div>
            <div className="reveal-up md:pl-12">
              <span className="text-5xl md:text-6xl font-bold text-neutral-950/[0.03] block mb-6 tracking-[-0.04em]">03</span>
      ...
      {/* 07. LEADERSHIP TEAM */}
      <section className="bg-[#050505] py-20 md:py-24 lg:py-32 text-white relative overflow-hidden">
        ...
        <div className="mx-auto max-w-[1600px] px-[5vw] relative z-10">
          <div className="mb-16 lg:mb-20">
            ...
            <h2 className="reveal-up text-[clamp(2rem,5vw,5rem)] font-semibold tracking-[-0.03em] leading-none">
            ...
            {leaders.map((l, i) => (
              <div key={i} className="group cursor-pointer">
                <div className="relative aspect-[3/4] w-full overflow-hidden mb-6 bg-white/5 border border-white/10">
                  <Image src={l.image} alt={l.name} fill className="object-cover grayscale group-hover:grayscale-0 group-hover:scale-105 transition-all duration-700 ease-out" sizes="(max-width: 768px) 100vw, 33vw" />
                ...
                <h3 className="text-xl md:text-2xl font-semibold transition-transform duration-500 group-hover:-translate-y-1 tracking-[-0.02em]">{l.name}</h3>
      ...
      {/* 08. DOWNLOADABLE COMPANY PROFILE */}
      <section className="bg-[#F5F5F2] py-20 md:py-24 lg:py-32 relative overflow-hidden">
        <div className="mx-auto max-w-[1600px] px-[5vw] grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          <div className="lg:col-span-7">
            <p className="reveal-up font-mono text-[11px] font-semibold uppercase tracking-[0.4em] text-emerald-700 mb-4 flex items-center gap-3">
              <span className="block w-8 h-px bg-emerald-700"></span>
              Company Profile
            </p>
            <h2 className="reveal-up text-[clamp(2.5rem,7vw,7rem)] font-semibold tracking-[-0.04em] mb-8 leading-[0.9]">
              Explore the <br />{" "}
              <span className="text-neutral-400">Sampan Group Story.</span>
            </h2>
            <p className="reveal-up text-base md:text-lg text-neutral-600 mb-12 max-w-md leading-relaxed">
            ...
            <div className="reveal-up flex flex-col sm:flex-row gap-4">
              <button className="group inline-flex items-center justify-center gap-4 bg-neutral-950 text-white px-8 py-5 hover:bg-emerald-600 transition-colors duration-300">
              ...
              <button className="group inline-flex items-center justify-center gap-4 border border-neutral-300 px-8 py-5 hover:border-neutral-950 hover:bg-neutral-950 hover:text-white transition-all duration-300">
          ...
          <div className="lg:col-span-5 flex justify-center mt-12 lg:mt-0">
            <div className="relative w-64 md:w-72 h-96 bg-white border border-neutral-200 shadow-xl flex flex-col p-10 transition-transform duration-700 hover:scale-105 hover:-rotate-2">
              <div className="absolute left-0 top-0 h-full w-2 bg-emerald-600"></div>
              <div className="border-b border-neutral-200 pb-6 mb-6">
                <span className="font-mono text-[10px] text-neutral-500 uppercase tracking-[0.3em]">Sampan Group</span>
              </div>
              <h3 className="text-3xl md:text-4xl font-bold text-neutral-950 mb-auto tracking-[-0.03em]">Corporate <br /> Profile</h3>
              <div className="text-right mt-10">
                <span className="text-6xl md:text-7xl font-bold text-emerald-600 tracking-[-0.04em]">2026</span>
              </div>
      ...
      <section className="bg-[#050505] py-20 md:py-24 lg:py-32 text-white overflow-hidden relative">
        ...
        <div className="relative w-full overflow-hidden" style={{ maskImage: "linear-gradient(to right, transparent, black 10%, black 90%, transparent)", WebkitMaskImage: "linear-gradient(to right, transparent, black 10%, black 90%, transparent)" }}>
          <div className="marquee-track flex gap-16 md:gap-24 whitespace-nowrap">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="flex gap-16 md:gap-24 items-center">
                {["RJSC", "ISO 9001", "BIDA", "ICAB", "FBCCI", "BASIS"].map((logo, j) => (
                  <span key={j} className="text-3xl md:text-5xl font-bold text-white/15 hover:text-emerald-500 transition-colors cursor-pointer flex-shrink-0 tracking-[-0.03em]">{logo}</span>
                ))}
              </div>
            ))}
          </div>
      ...
      <section className="quote-section bg-emerald-600 text-white py-24 md:py-32 lg:py-48 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-[1600px] px-[5vw] text-center relative z-10">
          <div className="text-[clamp(1.5rem,7vw,8rem)] leading-[1.05] font-semibold tracking-[-0.04em]">
          ...
          <p className="quote-line mt-16 font-mono text-[11px] uppercase tracking-[0.4em] text-white/60 flex items-center gap-3 justify-center">
            <span className="block w-12 h-px bg-white/60"></span>- Sampan Group
      ...
      <section className="bg-[#050505] text-white py-20 md:py-24 lg:py-32">
        <div className="mx-auto max-w-[1600px] px-[5vw]">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-24">
            <div className="lg:col-span-7">
              ...
              <h2 className="reveal-up text-[clamp(2rem,8vw,8rem)] font-semibold leading-[0.9] tracking-[-0.04em]">
                Let&apos;s Build <br />{" "}
                <span className="text-white/40">A Better Future in Every Step.</span>
              </h2>
            </div>
            <div className="lg:col-span-4 lg:col-start-9 flex items-end">
              <p className="reveal-up text-white/60 text-lg leading-relaxed">
                For partnerships, investments, careers, or general enquiries, reach out to our team.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-t border-white/10 pt-16">
            <div className="lg:col-span-4 space-y-10">
              <div>
                ...
                <p className="flex items-start gap-4 text-white/80 text-base md:text-lg leading-relaxed">
              ...
              <div>
                ...
                <a href="mailto:info@sampangroup.com.bd" className="flex items-center gap-4 text-white/80 hover:text-emerald-500 transition-colors mb-2 text-base md:text-lg">
                  <FiMail className="text-emerald-500" /><span>info@sampangroup.com.bd</span>
                </a>
                <a href="tel:+8801912234588">
                  <p className="flex items-center gap-4 text-white/80 text-base md:text-lg">
              ...
              <div>
                ...
                <a href="mailto:careers@sampangroup.com" className="flex items-center gap-4 text-white/80 hover:text-emerald-500 transition-colors text-base md:text-lg">
                  <FiMail className="text-emerald-500" /><span>careers@sampangroup.com</span>
                </a>
              </div>
            </div>

            <div className="lg:col-span-7 lg:col-start-6 h-72 lg:h-96 bg-white/5 relative overflow-hidden border border-white/10 rounded-sm group">
              <iframe
