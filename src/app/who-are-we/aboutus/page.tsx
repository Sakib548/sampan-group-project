...
const milestones = [
  ...
  //   image:
  //     "https://images.unsplash.com/photo-1486406146926-c1240e1c7d8f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  // },
  {
    year: "2005",
...
export default function AboutUsPage() {
  ...
  return (
    <main
      ref={containerRef}
      className="bg-[#F5F5F2] text-neutral-950 overflow-x-hidden font-sans antialiased selection:bg-emerald-500 selection:text-white"
    >
      {/* 01. CINEMATIC HERO */}
      <section className="hero-section relative h-screen min-h-[700px] w-full flex items-end bg-[#050505] text-white overflow-hidden">
        <div className="hero-bg absolute inset-0 opacity-0 will-change-transform">
          <Image
            src="/images/about/About-Our-Company-2.png"
        ...
        <div className="hero-content relative z-10 w-full pb-16 md:pb-24">
          <div className="mx-auto max-w-[1600px] px-[5vw]">
            ...
            <h1 className="flex flex-col overflow-hidden text-[clamp(3rem,9vw,9rem)] font-semibold leading-[0.85] tracking-[-0.04em]">
              ...
              <span className="hero-line block text-white/40">
                Creating Possibilities.
              </span>
            </h1>
            <p className="hero-desc mt-8 max-w-xl text-lg leading-relaxed text-white/60 opacity-0">
              A diversified business group committed to creating sustainable
              enterprises, developing meaningful opportunities, and contributing
              to the economic and social progress of Bangladesh.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-12 gap-8 mb-20">
            ...
            <div className="col-span-12 lg:col-span-6 lg:col-start-7 flex flex-col justify-end gap-6">
              ...
              <p className="reveal-up text-base text-neutral-600 leading-relaxed">
                Today, Sampan Group stands as a testament to that vision,
                encompassing a diverse portfolio of industries. Our journey is
                driven by a commitment to sustainable growth and a passion for
                creating value that extends beyond balance sheets—enriching the
                lives of our employees, partners, and the communities we serve.
              </p>
            </div>
          </div>
      ...
      <section
        id="heritage-section"
        className="bg-[#050505] h-screen w-full overflow-hidden hidden lg:block text-white relative"
      >
        <div className="absolute top-0 left-0 w-full h-[2px] bg-white/5 z-10">
          <div
            ref={timelineProgressRef}
            className="h-full w-full bg-emerald-500 origin-left scale-x-0"
          ></div>
        </div>
            ...
            {milestones.map((m, i) => (
              <div key={i} className="w-[450px] shrink-0 group flex flex-col">
                ...
                <div className="flex items-center gap-4 mb-4 relative">
                  <span className="text-6xl font-bold text-white/[0.02] absolute -ml-4 -mt-4 pointer-events-none">
                    {m.year}
                  </span>
                  <div className="h-px w-12 bg-emerald-500"></div>
                  <span className="text-4xl font-semibold text-emerald-500 relative z-10">
                    {m.year}
                  </span>
                </div>
                <h3 className="text-2xl font-semibold mb-3 tracking-[-0.02em]">
                  {m.title}
                </h3>
      ...
      <section className="bg-[#050505] py-24 lg:hidden text-white">
        <div className="mx-auto max-w-[1600px] px-[5vw]">
          ...
          <h2 className="text-4xl font-semibold tracking-[-0.03em] mb-16 leading-none">
            A Journey of Progress.
          </h2>
            ...
            {milestones.map((m, i) => (
              <div key={i} className="flex gap-8 relative">
                ...
                <div className="pb-8 flex-1">
                  <span className="text-5xl font-bold text-emerald-500 block mb-3">
                    {m.year}
                  </span>
                  <h3 className="text-2xl font-semibold mb-3 tracking-[-0.02em]">
                    {m.title}
        ...
        <div className="mx-auto max-w-[1600px] px-[5vw] grid grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          <div className="col-span-12 lg:col-span-5 lg:pl-8">
            ...
            <blockquote className="reveal-up border-l border-emerald-500 pl-6 mb-10 text-neutral-600 text-lg leading-relaxed italic">
              &quot;Sampan Group is driven by a vision to create lasting value
              through innovation, responsible growth, and transformative
              opportunities that contribute to a stronger and more sustainable
              future.&quot;
            </blockquote>
        ...
        <div className="mx-auto max-w-[1600px] px-[5vw] grid grid-cols-12 gap-12 items-center">
          ...
          <div className="col-span-12 lg:col-span-5 grid grid-cols-2 gap-8">
            {stats.map((s, i) => (
              <div
                key={i}
                className={`reveal-up pl-6 ${i % 2 === 0 ? "border-l-2 border-emerald-500" : "border-l-2 border-transparent"}`}
              >
                <span
                  className="count-up text-6xl md:text-7xl font-bold block text-neutral-950 tracking-[-0.04em]"
                  data-value={s.value}
                  data-suffix={s.suffix}
                >
                  0{s.suffix}
                </span>
                <span className="mt-2 font-mono text-[10px] uppercase tracking-[0.3em] text-neutral-500 block font-semibold">
                  {s.label}
                </span>
              </div>
            ))}
        ...
        <div className="mx-auto max-w-[1600px] px-[5vw]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-0 border-t border-b border-neutral-300/60 py-16">
            <div className="reveal-up lg:border-r lg:border-neutral-300/60 lg:pr-12 pb-8 lg:pb-0">
              <span className="text-6xl font-bold text-neutral-950/[0.03] block mb-6 tracking-[-0.04em]">
                01
              </span>
              <h3 className="text-2xl font-semibold mb-6 tracking-[-0.02em]">
                Mission
              </h3>
              <p className="text-neutral-600 leading-relaxed text-lg">
                To build sustainable, industry-leading enterprises that drive
                economic growth and create lasting value for society.
              </p>
            </div>
              ...
              <div className="flex flex-col mt-4">
                {values.map((v, i) => (
                  <div
                    ...
                    className="border-b border-neutral-300/60 py-4 cursor-pointer group"
                  >
                    <div className="flex justify-between items-center">
                      <h4
                        className={`text-lg transition-colors ${activeValue === i ? "text-emerald-700" : "text-neutral-950"}`}
                      >
                        {v.title}
                      </h4>
                      <FiPlus
                        className={`transition-transform duration-300 ${activeValue === i ? "rotate-45 text-emerald-700" : ""}`}
                      />
                    </div>
                    <p
                      className={`text-sm text-neutral-600 transition-all duration-300 overflow-hidden ${activeValue === i ? "max-h-20 mt-3 opacity-100" : "max-h-0 opacity-0"}`}
                    >
                      {v.desc}
                    </p>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {leaders.map((l, i) => (
              ...
              >
                ...
                <h3 className="text-2xl font-semibold transition-transform duration-500 group-hover:-translate-y-1 tracking-[-0.02em]">
                  {l.name}
                </h3>
                <p className="font-mono text-[11px] uppercase tracking-[0.3em] mt-2 font-semibold text-emerald-500">
                  {l.role}
                </p>
        ...
        <div className="mx-auto max-w-[1600px] px-[5vw] grid grid-cols-12 gap-12 items-center relative z-10">
          <div className="col-span-12 lg:col-span-7">
            ...
            <p className="reveal-up text-lg text-neutral-600 mb-12 max-w-md leading-relaxed">
              Discover our businesses, projects, leadership, achievements and
              vision through our official company profile.
            </p>
          ...
          <div className="col-span-12 lg:col-span-5 flex justify-center mt-12 lg:mt-0">
            {/* Refined Editorial Profile Card */}
            <div className="relative w-72 h-96 bg-white border border-neutral-200 shadow-xl flex flex-col p-10 transition-transform duration-700 hover:scale-105 hover:-rotate-2">
              ...
              <h3 className="text-4xl font-bold text-neutral-950 mb-auto tracking-[-0.03em]">
                Corporate <br /> Profile
              </h3>
              <div className="text-right mt-10">
                <span className="text-7xl font-bold text-emerald-600 tracking-[-0.04em]">
                  2026
                </span>
              </div>
              <div className="mt-4 font-mono text-[10px] text-neutral-400 uppercase tracking-[0.3em]">
                Edition 01
              </div>
            </div>
          </div>
              ...
              <div key={i} className="flex gap-24 items-center">
                {["RJSC", "ISO 9001", "BIDA", "ICAB", "FBCCI", "BASIS"].map(
                  (logo, j) => (
                    <span
                      key={j}
                      className="text-5xl font-bold text-white/15 hover:text-emerald-500 transition-colors cursor-pointer flex-shrink-0 tracking-[-0.03em]"
                    >
                      {logo}
                    </span>
                  ),
        ...
        <div className="mx-auto max-w-[1600px] px-[5vw]">
            ...
            <div className="col-span-12 lg:col-span-7">
              ...
              <h2 className="reveal-up text-[clamp(3rem,8vw,8rem)] font-semibold leading-[0.9] tracking-[-0.04em]">
                ...
                <span className="text-white/40">
                  A Better Future in Every Step.
                </span>
              </h2>
            </div>
            <div className="col-span-12 lg:col-span-4 lg:col-start-9 flex items-end">
              <p className="reveal-up text-white/60 text-xl leading-relaxed">
                For partnerships, investments, careers, or general enquiries,
          ...
          <div className="grid grid-cols-12 gap-12 border-t border-white/10 pt-16">
            <div className="col-span-12 lg:col-span-4 space-y-10">
              <div>
                <h4 className="font-mono text-[10px] uppercase tracking-[0.3em] text-white/30 mb-4 font-semibold">
                  Head Office
                </h4>
                <p className="flex items-start gap-4 text-white/80 text-lg leading-relaxed">
                  ...
                  <span>
                    ...
                    Bashundhara, Dhaka, Bangladesh, 1229
                  </span>
                </p>
              </div>
              <div>
                ...
                <a
                  ...
                  className="flex items-center gap-4 text-white/80 hover:text-emerald-500 transition-colors mb-2 text-lg"
                >
              ...
              <div>
                ...
                <a
                  href="mailto:careers@sampangroup.com"
                  className="flex items-center gap-4 text-white/80 hover:text-emerald-500 transition-colors text-lg"
                >
                  <FiMail className="text-emerald-500" />
                  <span>careers@sampangroup.com</span>
                </a>
              </div>
            </div>
            ...
            <div className="col-span-12 lg:col-span-7 lg:col-start-6 h-64 lg:h-96 bg-white/5 relative overflow-hidden border border-white/10 rounded-sm group">
              <iframe
                ...
                style={{
                  border: 0,
                  filter:
                    "invert(0.92) hue-rotate(160deg) brightness(0.9) contrast(0.9) saturate(0.5)",
                }}
                loading="lazy"
