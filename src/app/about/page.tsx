...
export const metadata = {
  ...
  description:
    "Learn about Sampan Group, our vision, change somethings and the value we create across industries.",
};
      ...
      <section className="border-y border-neutral-900/10 bg-[#E8EFE9] px-8 py-16 sm:px-12 lg:px-20 lg:py-20">
        <div className="mx-auto grid w-full max-w-[1200px] gap-10 lg:grid-cols-[0.7fr_1.3fr] lg:gap-16">
          ...
          <div className="space-y-5 text-base leading-7 text-slate-600 sm:text-lg">
            <p>
              <strong className="font-semibold text-[#253247]">
                SAMPAN Group
              </strong>{" "}
            ...
            <p>
              ...
              integrity enrich the communities around them.
            </p>
            <p>
        ...
        <div className="mx-auto w-full max-w-[1400px]">
          <div className="flex flex-col justify-between gap-6 border-b border-[#253247]/15 pb-8 sm:flex-row sm:items-end">
            <div>
              ...
              <h2 className="mt-4 max-w-2xl text-[clamp(2.25rem,3.7vw,4rem)] font-semibold leading-tight tracking-tight">
                The principles behind our progress.
              </h2>
            </div>
            <p className="max-w-sm text-sm leading-6 text-slate-600 sm:text-right">
              Leadership, ambition, and responsible growth shape every Sampan
              venture.
            </p>
          </div>
          <div className="mt-10 grid gap-5 lg:grid-cols-3">
            {[
              [
                ...
                "/images/about/leadership_vision.png",
                "At the helm of SAMPAN Group is MD Emamul Hasan, whose vision for integrated growth and commitment to quality continue to guide the Group.",
              ],
              [
                "Global Footprint",
                "/images/about/global_footprint.png",
                "Sampan Group continues to expand through strategic partnerships, innovation, and a responsible approach to long-term growth.",
              ],
              [
                "Achievements and Recognition",
                "/images/about/achivement.png",
                "Our consistent performance, innovation, and customer focus continue to build trust and recognition across the markets we serve.",
              ],
            ].map(([title, image, description], index) => (
              <article
                key={title}
                className="reveal-item group overflow-hidden border border-[#253247]/15 bg-white transition duration-500 hover:-translate-y-1 hover:shadow-xl"
              >
                ...
                <div className="p-6 sm:p-7">
                  ...
                  <h3 className="mt-4 text-2xl font-semibold leading-tight text-[#253247]">
                    {title}
                  </h3>
        ...
        <div className="mx-auto grid w-full max-w-[1400px] gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-24">
          ...
          <div className="reveal-item">
            ...
            <h2 className="mt-5 text-[clamp(2.25rem,3.7vw,4rem)] font-semibold leading-tight tracking-tight">
              Empowering tomorrow, shaping a sustainable future.
            </h2>
            <p className="mt-6 text-base leading-8 text-slate-600 sm:text-lg">
              Our vision is to be a globally respected and diversified business
              group, recognized for creating enduring value through innovation,
              sustainability, and responsible leadership. We aim to empower
              communities, advance industries, and embrace future-forward
              solutions.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto grid w-full max-w-[1400px] gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:gap-24">
          <div className="reveal-item order-2 lg:order-1">
            ...
            <p className="mt-6 text-base leading-8 text-white/70 sm:text-lg">
              At Sampan Group, our mission is to lead with integrity,
              innovation, and excellence across all our ventures. We are
              committed to delivering superior value to our customers, partners,
              and communities through quality, sustainable growth, social
              responsibility, and transparent leadership.
            </p>
          </div>
          <div className="reveal-item relative order-1 aspect-[4/3] overflow-hidden lg:order-2">
            <Image
              src="/images/about/mission.png"
              alt="Sampan Group mission and teamwork"
              fill
              sizes="(max-width: 1024px) 100vw, 55vw"
              className="object-cover"
            />
